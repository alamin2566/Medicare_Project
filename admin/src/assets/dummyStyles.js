...
export const dashboardStyles = {
  ...
  headerTitle: "text-3xl md:text-4xl font-extrabold uppercase tracking-wide text-gray-800",
  ...
  statCard: "px-5 py-4 rounded-full bg-white shadow-sm border border-green-100 flex items-center gap-4",
  statContent: "flex items-center gap-4",
  statIconContainer: "w-10 h-10 flex items-center justify-center text-gray-700 shrink-0",
  statTitle: "text-sm text-slate-500",
  statValue: "text-xl font-bold text-slate-800",

  searchLabel: "block text-base font-medium text-slate-700 mb-2",
  searchContainer: "flex items-center gap-3 max-w-md",
  searchInputContainer: "relative flex-1 flex items-center bg-white border border-gray-300 rounded-full px-4 py-2 shadow-sm",
  searchInput: "flex-1 outline-none text-slate-700 placeholder-slate-400 bg-transparent text-sm",
  searchIcon: "w-4 h-4 text-gray-400 mr-2 shrink-0",
  clearButton: "px-5 py-2 bg-emerald-600 text-white rounded-full shadow hover:bg-emerald-700 text-sm font-medium",
  cursorPointer: "cursor-pointer",
...
header: "relative font-serif bg-white border-b border-gray-100",  
navbarContainer: "mx-auto max-w-7xl lg:px-7 xl:px-2 px-4 py-5",
 flexContainer: "flex items-center justify-between",
  ...
  logoSubtitle: "text-xs xl:block text-gray-500",

  centerNavContainer: "hidden lg:flex items-center justify-center relative flex-1",
  glowEffrect: "relative rounded-full p-1 bg-white shadow-md border border-gray-100",
  centerNavINNER: "relative flex items-center",
  centerNavScrollContainer: "whitespace-nowrap rounded-full bg-white lg:px-2 px-4 py-2 flex items-center gap-2 overflow-x-auto",

  centerNavItemBase: "relative flex flex-col lg:text-xs xl:text-md items-center gap-1 px-3 py-2 rounded-lg transition-all text-sm",
  ...
  signInButton: "px-4 py-2 cursor-pointer rounded-full bg-amber-500 text-white text-sm shadow-sm",
  signOutButton: "px-4 py-2 cursor-pointer rounded-full bg-amber-500 text-white text-sm shadow-sm",
  cursorPointer: "cursor-pointer",

  mobileMenuButton: "lg:hidden p-2 rounded-full bg-white shadow",
  mobileOverlay: "fixed inset-0 z-10 lg:hidden",
  mobileNavContainer: "mt-3 lg:hidden z-20 relative",
  ...
  mobileSingOutButton: "w-full py-2 rounded-full border bg-amber-500 text-white font-medium",
  mobileLoginButton: "w-full cursor-pointer py-2 rounded-full border bg-amber-500 text-white font-medium",

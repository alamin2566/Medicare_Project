...
function getSortedScheduleDates(scheduleLike) {
  ...
  if (Array.isArray(scheduleLike)) {
    keys = scheduleLike
      .map(normalizeToDateString)
      .filter(Boolean);
  } else if (scheduleLike && typeof scheduleLike === "object") {
    keys = Object.keys(scheduleLike)
      .map(normalizeToDateString)
      .filter(Boolean);
  }
    ...
    <div className={doctorListStyles.container}>
      ...
      <main className={doctorListStyles.gridContainer}>
        ...
        {displayed.map((doc) => {
          ...
          const sortedDates =
            getSortedScheduleDates(scheduleMap);

          return (
            <article
              key={id}
              className={doctorListStyles.article}
            >
              <div className={doctorListStyles.articleContent}>
                ...
                <div
                  className={
                    doctorListStyles.doctorInfoContainer
                  }
                >
                  <div
                    className={
                      doctorListStyles.doctorHeader
                    }
                  >
                    <div className="min-w-0 w-full">
                      ...
                      <div
                        className={
                          doctorListStyles.doctorDetails
                        }
                      >
                        {doc.specialization} •{" "}
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                    <div className={doctorListStyles.aboutSection}>
                      ...
                      <div className="mt-4">
                        <div
                          className={
                            doctorListStyles.qualificationsHeading
                          }
                        >
                          Qualifications
                        </div>
                        ...
                        <div
                          className={
                            doctorListStyles.qualificationsText
                          }
                        >
                          {doc.qualifications}
                        </div>
                      ...
                      <div className="mt-4">
                        <div
                          className={
                            doctorListStyles.scheduleHeading
                          }
                        >
                          Schedule
                        </div>
                    ...
                    <aside
                      className={
                        doctorListStyles.statsSidebar
                      }
                    >
                      <div
                        className={
                          doctorListStyles.statsItemHeading
                        }
                      >
                        Success
                      </div>
                      ...
                      <div
                        className={
                          doctorListStyles.statsItemValue
                        }
                      >
                        {doc.success}%
                      </div>
                      ...
                      <div
                        className={
                          doctorListStyles.locationValue
                        }
                      >
                        {doc.location}
                      </div>

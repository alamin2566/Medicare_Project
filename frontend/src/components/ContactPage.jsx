...
import { User, Mail, Phone, MapPin, Stethoscope, SendHorizonal, MenuSquare } from 'lucide-react'
      ...
      <div className={contactPageStyles.gridContainer}>
        <div className={contactPageStyles.formContainer}>
          ...
          <p className={contactPageStyles.formSubtitle}>
            Fill the form- we will open whatsAPP so you can connect with us instantly
          </p>
          ...
          <form onSubmit={handleSubmit} className={contactPageStyles.formSpace}>
           ...
           <div>
            ...
            <div>
              ...
              onChange={handleChange} className={contactPageStyles.input}>
                <option value="">
        ...
        <div className={contactPageStyles.infoContainer}>
         <div className={contactPageStyles.infoCard}>
          ...
          <p className={ contactPageStyles.infoText}>
            PanthPath,kolabaghan,Dhaka
          </p>
          <p className={contactPageStyles.infoItem}>
            <Phone size={16} /> +8801323156155
          </p>
           <p className={contactPageStyles.infoItem}>
            <Mail size={16} /> alamin@gmail.com
          </p>
          </div> 
        <iframe
  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d233668.3422417046!2d90.27867867578125!3d23.780573000000003!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3755b8b087026b81%3A0x8fa563bbdd5904c2!2sDhaka%2C%20Bangladesh!5e0!3m2!1sen!2sbd!4v1731769000000!5m2!1sen!2sbd"
...
></iframe>
     ...
     <div className={contactPageStyles.hoursContainer}>
      <h4 cllassName={contactPageStyles.hoursTitle}>Clinic Hours</h4>
